...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvTime :TextView = itemView.findViewById(R.id.tv_start_time_pager)
        private val tvMinutes :TextView = itemView.findViewById(R.id.tv_minutes_pager)
        val ivPriority : ImageView = itemView.findViewById(R.id.item_priority_level_pager)
        private val btnCount :Button = itemView.findViewById(R.id.btn_open_count_down_pager)
